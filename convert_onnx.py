...
torch_model = SiameseNetwork()
torch_model.eval()
torch_input_1 = torch.randn(1,3,224,224)
torch_input_2 = torch.randn(1,3,224,224)
onnx_program = torch.onnx.export(torch_model , (torch_input_1,torch_input_2),
"person_re.onnx",
input_names=['person1' , 'person2'],
output_names=['similarity'],
    dynamic_axes={                           # Dynamic batch size and image dimensions
        "person1": {0: "batch_size", 2: "height", 3: "width"},
        "person2": {0: "batch_size", 2: "height", 3: "width"},
