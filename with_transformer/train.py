...
from paired_image import PairedImageDataset
from backbone import SiameseTransformerNetwork
import argparse
...
model = SiameseTransformerNetwork(backbone=args.backbone).to(device)
